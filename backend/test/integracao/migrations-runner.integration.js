...
const TOTAL_MIGRATIONS_REAIS = 40;
...
describe('aplicação das migrations reais em schema vazio', () => {
  ...
  test('aplica e registra as 40 migrations em ordem crescente', async () => {
...
describe('baseline: registro sem execução', () => {
  ...
  test('o baseline registra as 40 sem executar o SQL', async () => {
