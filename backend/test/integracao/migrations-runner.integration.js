...
const TOTAL_MIGRATIONS_REAIS = 27;
...
describe('aplicação das migrations reais em schema vazio', () => {
  ...
  test('aplica e registra as 27 migrations em ordem crescente', async () => {
...
describe('baseline: registro sem execução', () => {
  ...
  test('o baseline registra as 27 sem executar o SQL', async () => {
