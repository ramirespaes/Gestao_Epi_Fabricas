 ...
 * diretório temporário com migrations sintéticas. Os arquivos reais 000 a 026
...
const TOTAL_MIGRATIONS_REAIS = 39;
...
describe('aplicação das migrations reais em schema vazio', () => {
  ...
  test('aplica e registra as 39 migrations em ordem crescente', async () => {
...
describe('baseline: registro sem execução', () => {
  ...
  test('o baseline registra as 39 sem executar o SQL', async () => {
