...
// alteram estado (antes de ler ou interpretar o corpo), política de conteúdo
// (exige application/json quando há corpo em POST/PUT/PATCH e interpreta JSON
// com o limite do projeto) e rotas. Fora de /api nada disso se aplica.
app.use('/api', corsApi, semCache, verificarOrigem, exigirJson, parserJson, healthRoutes);
